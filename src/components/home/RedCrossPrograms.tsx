          ...
          <div className="lg:w-1/2 w-full space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-green-600">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>
                  <span className="font-medium">7-level preschool program</span>{" "}
                  for 6 months and up
                </li>
                <li>
                  Children enter levels based on age and then progress based on
                  either age or ability
                </li>
                <li>
                  Opportunity for parents and their children to become
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>
                  <span className="font-medium">
                    10-level program for kids.
                  </span>{" "}
                  Children feel proud of their achievement as they get through
                  all levels
                </li>
                <li>
                  Swimming and Water Safety skills are taught in the water so
                  kids are always active and wet
                </li>
                <li>
